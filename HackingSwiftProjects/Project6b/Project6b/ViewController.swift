...
//  Project6b
//
//  Created by DongKyu Kim on 2022/07/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let label1 = UILabel()
        // Autolayout Contraint를 자동이 아닌 수동으로 설정하기
...
//        }
//
//        // metrics로 파라미터화 해서 전달
//        let metrics = ["labelHeight": 88]
//
//        // ==80 : 높이, (>=10) : space
//        // @999, ... : Contstraint Priority (default는 1000이고 높을수록 중요도 높음, 따라서 낮으면 fit 하게 만듦
